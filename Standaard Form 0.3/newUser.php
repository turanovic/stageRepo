...
<html lang="nl">
    ...
    <body>
        ...
        <form method="post" name="create_user" action="resources/php/config.php">
            <input type="hidden" name="stage" value="2">
            <!-- Vraag 1 -->
            <h3>1. Wat is je geboortedatum?</h3>
            <input type="date" name="birthdate" max="1-1-1900" min="1-1-2010">
            ...
            <!-- Vraag 7 -->
            <h3>Vul hier je E-Mail adres in</h3>
